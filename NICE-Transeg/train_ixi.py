...
# project imports
from datagenerators import NICE_Transeg_Dataset_IXI, NICE_Transeg_Dataset_Infer_IXI, print_gpu_usage
import networks
import losses
...
def train(train_dir,
    ...
    train_dl = DataLoader(NICE_Transeg_Dataset_IXI(train_dir, device, atlas_dir), batch_size=batch_size, shuffle=True, drop_last=False)
    valid_dl = DataLoader(NICE_Transeg_Dataset_Infer_IXI(valid_dir, device), batch_size=2, shuffle=True, drop_last=True)
